    ...
    <div className="absolute bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
        ...
        <section className="mt-10">
            <div className="flex flex-col" >
                ...
                <button  className="bg-slate-600 hover:bg-purple-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">Sign Un</button>
        ...
        <p className="text-slate-600">Become a new chicken already? <Link to="/loginwithemail" className="font-bold hover:underline">Sign in</Link>.</p>
    </div>
    </div>
    </div>;
};
